...
I recently encountered an interesting bug and the moment of realisation that caused it is when I learnt the even something as harmless as database read optimisation could lead to a significant error.
